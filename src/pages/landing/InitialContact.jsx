...
const InitialContact = () => {
  return (
    <div className="flex justify-center flex-row sm:flex-col flex-row gap-[5rem]">
      <section
        className="flex justify-center w-[31.75rem] h-[61.75rem] pb-6 pb-8
                     py-10"
        id="contact-section"
      >
        <div className="container flex mx-auto flex-col sm:flex-col flex-row ">
          <div className="mt-5">
            <h2 className="py-1.5 lg:py-2.5  text-[2rem]  font-semibold  lg:mx-auto text-poppins text-[#140B34]">
              DEVsafiamos el sistema
            </h2>
            <h5 className=" w-[31.75] leading-relaxed  text-[1.25rem] my-5  font-medium mx-auto">
            ...
            <h5 className=" leading-relaxed  font-medium text-[1.25rem] my-10 mx-auto">
            ...
            <h5 className="py-3 leading-relaxed  text-[1.25rem]  mx-auto">
              <b>
