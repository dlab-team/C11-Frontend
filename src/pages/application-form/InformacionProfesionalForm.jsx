        ...
        <div className='lg:ml-[25rem]'>
            <form action="" className='w-full lg:w-[90%]'>
                <div class=" md:w-3/3 px-3 mb-[1.38rem] md:mb-0">
                    ...
                    <div class="relative">
                        <select class="block appearance-none w-full bg-[#E2F2FE] border border-[#140B34] text-[#575253] py-1 px-4 pr-8 rounded-[0.5rem] leading-tight focus:outline-none focus:bg-white focus:border-gray-500" id="grid-state" >
                ...
                <div class="w-full md:w-3/3 px-3 mb-[1.38rem] md:mb-0 lg:mb-[1.5rem]">
                    <label class="block tracking-wide text-black text-xs text-[0.75rem] lg:text-[1.25rem] font-semibold mb-2 lg:mb-[1.5rem]" for="grid-first-name">
                    Nombre de la carrera, curso, bootcamp o certificación 1:<span className='text-[#AC231B]'>*</span>
                    </label>
                    <input class="appearance-none block w-full bg-[#E2F2FE] border border-[#140B34] text-[#575253] rounded-[0.5rem] py-1 px-4 leading-tight focus:outline-none focus:bg-white" id="grid-first-name" type="text" placeholder=""/>
                </div>
                <div class="w-full md:w-3/3 px-3 mb-[1.38rem] md:mb-0">
                    <label class="block tracking-wide text-black text-xs lg:text-[1.25rem] font-normal font-poppins mb-2 lg:mb-[1.25rem]" for="grid-first-name">
                        Nombre institución 1:<span className='text-[#AC231B]'>*</span>
                    </label>
                    <input class="appearance-none block w-full bg-[#E2F2FE] border border-[#140B34] text-[#575253] rounded-[0.5rem] py-1 px-4 mb-3 leading-tight focus:outline-none focus:bg-white" id="grid-first-name" type="text" placeholder=""/>
                </div>
                <div class="w-full md:w-3/3 px-3 md:mb-0 lg:mb-[1.81rem]">
                    <label class="block tracking-wide text-black text-xs lg:text-[1.25rem] font-normal mb-2 lg:mb-[1.5rem]" for="grid-state">
                ...
                <div className='grid grid-cols-2 lg:flex lg:flex-row'>
                    <div class="w-full md:w-5/5 lg:w-[36.8rem] px-3 md:mb-0">
                        ...
                        <div class="relative">
                            <select class="block appearance-none w-full bg-[#E2F2FE] border border-[#140B34] text-[#575253] px-4 lg:py-1 pr-8 rounded-[0.5rem] leading-tight focus:outline-none focus:bg-white focus:border-gray-500" id="grid-state">
                            <option>Selección</option>
                    ...
                    <div class="grid grid-cols-1 items-end w-full md:w-2/3 lg:w-[24rem] px-3 md:mb-0">
                        ...
                        <div class="relative">
                            <select class="block appearance-none w-full bg-[#E2F2FE] border border-[#140B34] text-[#575253] px-4 lg:py-1 pr-8 rounded-[0.5rem] leading-tight focus:outline-none focus:bg-[#E2F2FE] focus:border-gray-500" id="grid-state">
                            <option>Selección</option>
                            <option>Missouri</option>
                            <option>Texas</option>
                            </select>
