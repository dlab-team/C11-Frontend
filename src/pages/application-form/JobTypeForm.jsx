...
function JobTypeForm() {
  ...
  return (
    <section className="md:pt-[69px] md:pb-[61px] md:px-[150px] bg-[white] px-[30px] text-[color:black]">
      ...
      <h1 className=" text-center lg:text-left lg:ml-[16.69px] font-bold mb-[21px] lg:text-[2rem] lg:font-bold font-poppins">
        ¿QUÉ TIPO DE TRABAJO ESTÁS BUSCANDO?
      </h1>
      <form
        action=""
        className="lg:ml-[94px] lg:mr-0 pl-[42px] pr-[43px] lg:pl-0 lg:pr-0 max-w-[996px]"
      >
        <div>
        ...
        <div className="lg:flex gap-x-[36px]  lg:mt-[32px]">
          ...
          <div className="mt-[72px] lg:mt-0">
            ...
            <div className="flex flex-col invisible lg:visible lg:gap-[16px]">
              {employmentStatusOptions.map((status, index) => (
                <label key={index} className="flex items-center mr-4">
                  <input
                    ...
                    value={status.value}
                    className="form-radio h-4 w-4 text-[#575253] border border-[#140B34] focus:outline-none focus:border-gray-500"
                  />
