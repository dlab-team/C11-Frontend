            ...
            <form action="" className='w-full lg:w-[100%]' >
                ...
                <div className='lg:flex lg:flex-row lg:justify-between'> 
                    <div className="w-full md:w-3/3 lg:w-[24.12rem] px-3 mb-[1.38rem] md:mb-0">
                        <label className="block tracking-wide text-black text-xs lg:text-[1.25rem] font-bold font-poppins mb-1 lg:mb-[1.25rem]" for="grid-first-name">
                            Lenguaje
                        </label>
                        <div className="relative divide-x divide-[#140B34]">
                            <select className="block appearance-none w-full bg-[#E2F2FE] border border-[#140B34] text-[#575253] lg:text-[1.25rem] py-1 lg:py-2 px-4 pr-8 rounded-[0.5rem] leading-tight focus:outline-none focus:bg-white focus:border-gray-500" id="grid-state" >
                    ...
                    <div className="w-full md:w-3/3 lg:w-[24.12rem] px-3 md:mb-0 lg:mb-[1.81rem]">
                        <label className="block tracking-wide text-black text-xs lg:text-[1.25rem] font-bold mb-1 lg:mb-[1.5rem]" for="grid-state">
                            Nivel
                        </label>
                        <div className="relative divide-x divide-[#140B34]">
                            <select className="block appearance-none w-full bg-[#E2F2FE] border border-[#140B34] text-[#575253] lg:text-[1.25rem] py-1 lg:py-2 px-4 pr-8 rounded-[0.5rem] leading-tight focus:outline-none focus:bg-white focus:border-gray-500" id="grid-state" >
                ...
                <div className="w-full md:w-3/3 px-3 mb-[1.38rem] mt-[4.06rem] lg:mt-[4.66rem] md:mb-0  lg:w-[62.25rem]">
                    <label className="block tracking-wide text-black text-[0.68rem] lg:text-[1.25rem] text-center lg:text-justify font-normal font-poppins mb-[0.81rem] lg:mb-[2.69rem]" for="grid-first-name">
                    Indícanos alguna otra competencia, herramienta o tecnología que conozcas que creas importante agregar:
                    </label>
                    <input className="appearance-none block w-full bg-[#E2F2FE] border border-[#140B34] text-[#575253] rounded-[0.5rem] h-[4.75rem] lg:h-[6.67rem] py-1 lg:py-2 px-4 mb-3 leading-tight focus:outline-none focus:bg-white" id="grid-first-name" type="text" placeholder=""/>
                </div>
                _____________Botones_____________
                {/* <div className='flex justify-center mb-[1rem] mt-[9.62rem]'>
                    <div className="inline-flex">
                        <button className="bg-white text-[#2738F5] border-[1px] border-[#2738F5] font-bold py-2 px-8 lg:px-10 rounded-l-xl mr-[0.31rem] lg:mr-[1.25rem] lg:text-[1.5rem]">
                            Atrás
                        </button>
                        <button className="bg-[#2738F5] text-white font-bold py-2 px-4 rounded-r-xl lg:text-[1.5rem]">
                            Continuar
                        </button>
                    </div>
                </div> */}
